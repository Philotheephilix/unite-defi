...
describe('Funded Cross-Chain Swap Test', () => {
    let src: {
    ...
    beforeAll(async () => {
        console.log('Starting funded cross-chain swap test...')
        ...
        console.log('Setup complete. Ready for funded swap test.')
    }, 60000) // 60 second timeout

    it('should fund resolver and perform a real cross-chain USDC swap', async () => {
        ...
        // Step 7: Create destination escrow immutables
        const dstImmutables = {
            ...srcImmutables,
        ...
        // Step 8: Deploy destination escrow
        ...
        // Step 9: Resolver fills the destination escrow
        ...
        // Step 10: Reveal secret on source chain to complete the swap
